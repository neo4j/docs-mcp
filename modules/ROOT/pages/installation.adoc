...
[NOTE]
====
For HTTP mode configuration, TLS/HTTPS setup, and detailed transport mode documentation, see xref:usage/configuration.adoc#transport-modes[Transport modes], xref:usage/configuration.adoc[Configuration], and xref:tls-setup.adoc[TLS/HTTPS Setup] sections.
====
