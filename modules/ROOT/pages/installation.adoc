...
[NOTE]
====
For HTTP mode configuration, TLS/HTTPS setup, and detailed transport mode documentation, see xref:usage.adoc#transport-modes[Transport modes] and xref:usage.adoc#configuration[Configuration] sections.
====
