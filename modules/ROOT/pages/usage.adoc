...
| `NEO4J_DATABASE`     | Database name (e.g., `neo4j`) | _Required_
...
*Note:* The three required connection parameters (URI, username, and password) must be provided via environment variables, command-line flags, or a combination of both. There are no default values.
